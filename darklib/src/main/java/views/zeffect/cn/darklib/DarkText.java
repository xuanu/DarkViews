...
public class DarkText extends TextView {
    public DarkText(Context context) {
        super(context);
    }

    public DarkText(Context context,AttributeSet attrs) {
        super(context, attrs);
    }

    public DarkText(Context context, AttributeSet attrs, int defStyleAttr) {
